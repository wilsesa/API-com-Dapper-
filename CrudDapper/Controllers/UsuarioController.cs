...
namespace CrudDapper.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CriarUsuario(CriarUsuarioDto usuarioCriarDto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> EditarUsuarios(UsuarioEditarDto usuarioEditarDto)
        {
